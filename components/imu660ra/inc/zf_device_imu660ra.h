...
* 2025-03-31        JJY             transplant to esp32 platform 
********************************************************************************************************************/
...
#define IMU660RA_I2C_SPEED_HZ       ( 400*1000 )
#define IMU660RA_I2C_ADDR           ( 0x69 )
#define IMU660RA_ACC_SAMPLE_DEFAULT     ( IMU660RA_ACC_SAMPLE_SGN_8G )          // 在这设置默认的 加速度计 初始化量程
#define IMU660RA_GYRO_SAMPLE_DEFAULT    ( IMU660RA_GYRO_SAMPLE_SGN_1000DPS )    // 在这设置默认的 陀螺仪   初始化量程
...
#define system_delay_ms(ms)     (vTaskDelay(pdMS_TO_TICKS(ms)))
...
uint8_t imu660ra_init(i2c_port_num_t port_num);                                     // 初始化 IMU660RA
